...
namespace Lets.Be
{
    partial class Rational
    {
        ...
        {
            double[] a = { 3.1611237438705656, 113.864154151050156, 377.485237685302021, 3209.37758913846947, .185777706184603153 };
            double[] b = { 23.6012909523441209, 244.024637934444173, 1282.61652607737228, 2844.23683343917062 };
            double[] c__ = { .564188496988670089, 8.88314979438837594, 66.1191906371416295, 298.635138197400131, 881.95222124176909, 1712.04761263407058, 2051.07837782607147, 1230.33935479799725, 2.15311535474403846e-8 };
            ...
            double[] p = { .305326634961232344, .360344899949804439, .125781726111229246, .0160837851487422766, 6.58749161529837803e-4, .0163153871373020978 };
            double[] q = { 2.56852019228982242, 1.87295284992346047, .527905102951428412, .0605183413124413191, .00233520497626869185 };
        ...
        static double erf_cody(double x)
        {
            /* -------------------------------------------------------------------- */
