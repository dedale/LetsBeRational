...
namespace Lets.Be
{
    ...
    {
        static readonly double minimum_rational_cubic_control_parameter_value = -(1 - Math.Sqrt(DBL_EPSILON));
        static readonly double maximum_rational_cubic_control_parameter_value = 2 / (DBL_EPSILON * DBL_EPSILON);
        static bool is_zero(double x) { return Math.Abs(x) < DBL_MIN; }
        ...
        static double rational_cubic_interpolation(double x, double x_l, double x_r, double y_l, double y_r, double d_l, double d_r, double r)
        {
            ...
            {
                t = (x - x_l) / h; double omt = 1 - t, t2 = t * t, omt2 = omt * omt;
        ...
        static double minimum_rational_cubic_control_parameter(double d_l, double d_r, double s, bool preferShapePreservationOverSmoothness)
        {
        ...
        static double convex_rational_cubic_control_parameter_to_fit_second_derivative_at_left_side(double x_l, double x_r, double y_l, double y_r, double d_l, double d_r, double second_derivative_l, bool preferShapePreservationOverSmoothness)
        {
        ...
        static double convex_rational_cubic_control_parameter_to_fit_second_derivative_at_right_side(double x_l, double x_r, double y_l, double y_r, double d_l, double d_r, double second_derivative_r, bool preferShapePreservationOverSmoothness)
        {
